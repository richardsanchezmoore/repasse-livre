...
const CHAT = {
  ...
  r2_ninguem: {
    lady: [
      ...
      "Já vi muitas mulheres passarem por isso. Cada uma tem a sua história, mas quase todas enfrentam exatamente os mesmos obstáculos.",
    ],
    opts: [
      ...
      {step === 1 && (
        <>
          <div className="sw-card rola" key="c1">
            <div className="sw-muda-h" style={{ fontSize: "clamp(23px,6vw,28px)", marginBottom: 6 }}>O problema nunca foi você</div>
            ...
            <div className="sw-oferta-card">
              ...
              <div className="sw-assina sw-assina-oferta">
                ...
                <div className="sw-assina-txt">
                  <div className="sw-assina-n">Lady Helena M.</div>
